...
$message .= "https://yavarmish.host20.uk/onlinenotes/resetpassword?user_id=$user_id&key=$key";
if(mail($email, 'Reset your password', $message, 'From:'.'onlinenotesofficial@gmail.com')){
