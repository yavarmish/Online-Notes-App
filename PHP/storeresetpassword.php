...
if(!$result){
    ...
    echo '<p class="alert alert-success"><strong>Your password has been updated successfully!</strong><a href="/onlinenotes" style="display: block;">Back to home page</a></p>';  
}
?>