        ...
        <section class="clean-block features">
            <div class="container">
                <div class="block-heading">
                    ...
                    <p>This is version 1.1 of the app and it includes the basic functionalities such as saving notes, editing and deleting them. 
                    The notes are personalized and sorted in the order they are created or edited.</p>
                </div>
                <div class="row justify-content-center">
                    <div class="col-md-5 feature-box"><i class="icon-star icon"></i>
                        <h4>Personalized experience</h4>
                        <p>Your own space as you log in, notes are personalized and you can organize them the way you like.Completely secure.</p>
                    </div>
                    <div class="col-md-5 feature-box"><i class="icon-pencil icon"></i>
                        <h4>Customizable</h4>
                        <p>Edit your notes anytime you feel something's off. Quick updation and organization</p>
                    </div>
                    <div class="col-md-5 feature-box"><i class="icon-screen-smartphone icon"></i>
                        <h4>Responsive</h4>
                        <p>Automatically adjusts for different screen sizes and viewports(desktops, tablets, and phones)</p>
                    </div>
                    <div class="col-md-5 feature-box"><i class="icon-refresh icon"></i>
                        <h4>All Browser Compatibility</h4>
                        <p>Functions across different browsers and degrades gracefully when browser features are absent or lacking.</p>
                    </div>
                </div>
